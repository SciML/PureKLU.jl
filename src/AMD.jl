...
"""
function amd_aat!(n::Int, Ap::AbstractVector{Ti}, Ai::AbstractVector{Ti},
                  Len::AbstractVector{Ti}, Tp::AbstractVector{Ti}) where {Ti<:Integer}
...
"""
function amd_2!(n::Int, Pe::Vector{Ti}, Iw::Vector{Ti}, Len::Vector{Ti},
...
"""
function amd_postorder!(nn::Int, Parent::Vector{Ti}, Nv::Vector{Ti}, Fsize::Vector{Ti},
                        Order::Vector{Ti}, Child::Vector{Ti}, Sibling::Vector{Ti},
                        Stack::Vector{Ti}) where {Ti<:Integer}
...
"""
function amd_post_tree!(root::Int, k_in::Int, Child::Vector{Ti}, Sibling::Vector{Ti},
...
"""
function amd_order!(n::Int, Ap::AbstractVector{Ti}, Ai::AbstractVector{Ti},
                    P::Vector{Ti};
                    dense_alpha::Float64=AMD_DEFAULT_DENSE,
                    aggressive::Bool=AMD_DEFAULT_AGGRESSIVE != 0) where {Ti<:Integer}
